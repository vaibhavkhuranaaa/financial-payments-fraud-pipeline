...
(Schema registry + typed events — the previous top item here — shipped in v1.6: registry-framed Avro on `transactions`, `make demo`/`make demo-cdc`, ADR 0006, both demo modes live-verified end to end including the dashboard. CDC ingestion shipped in v1.2, ADR 0003.)
